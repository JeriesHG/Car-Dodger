...
public class DrawLine : MonoBehaviour
{
	...
	//Stored information about collisions
	public bool drawLineCast = true;
	//Sets if circle gizmo can be drawn
	public float XLineDirection = 0;
	//Sets the line direction on X
	public float YLineDirection = 0;
	//Sets the line direction on Y
	public Color lineColor;
	//Sets the line gizmo color
	public LayerMask lineCollisions;
	//Sets the collisions for the line
	public GameObject parentObject;
	//If line has a parent object then it will change its transform localX and localY to match its parent
